...
packet {
  ...
  interned_data {
    ...
    frames { iid: 1 function_name_id: 1 mapping_id: 1 }
...
class V8CpuProfile(TestSuite):
  ...
  def test_v8_cpu_profile_session_view(self):
  ...
  def test_v8_cpu_profile_legacy_export_node(self):
    return DiffTestBlueprint(
        ...
        """,
        out=Csv("""
        "node_id","parent_node_id","function_name","url","line_number","column_number","code_type","deopt_reason"
        1,"[NULL]","fnA","[NULL]","[NULL]","[NULL]","other","[NULL]"
        2,1,"fnB","[NULL]","[NULL]","[NULL]","other","[NULL]"
        """))
  ...
  def test_v8_cpu_profile_legacy_export_sample(self):
    return DiffTestBlueprint(
        ...
        """,
        out=Csv("""
        "node_id","delta_us","leaf_line","leaf_column"
        1,5,0,0
        2,10,0,0
        """))
