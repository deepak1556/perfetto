...
TEST_F(ExportJsonTest, V8CpuProfileRawEvents) {
  ...
  // Find Profile and ProfileChunk events.
...
// Test the new V8 CPU profile path: synthesize Profile/ProfileChunk JSON from
// the native __intrinsic_v8_cpu_profile_* tables. Asserts field-level parity
// with the legacy DevTools format.
